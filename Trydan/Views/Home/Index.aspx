...
<head runat="server">
	<link rel="stylesheet" type="text/css" href="~/Content/css/Trydan.css" />
	<title></title>
</head>
<body>
	<div class="header"><h1>Trydan</h1></div>
	<div>
		<div class="add_reading"><%= Html.ActionLink("add reading", "AddReading") %></div> <div class="add_payment"><a href="">add payment</a></div>
